...
export const ADMIN_ORDERS: AdminOrder[] = [
  { ref: "BI-9F2K1A", date: "2026-06-03", customer: "Thabo Nkosi", store: "Build It Strand", fulfilment: "Delivery", status: "New", totalCents: 184800, items: [{ name: "Dulux Weatherguard 20L White", qty: 1, priceCents: 169900 }, { name: "Radiant 3 Bar Heater", qty: 1, priceCents: 34990 }] },
  { ref: "BI-7C4M8D", date: "2026-06-03", customer: "Lerato Dlamini", store: "Build It Strand", fulfilment: "Collect", status: "Preparing", totalCents: 129900, items: [{ name: "Ingco 20V Impact Drill Kit", qty: 1, priceCents: 129900 }] },
  { ref: "BI-2P8Q5R", date: "2026-06-02", customer: "Pieter van Wyk", store: "Build It Stellenbosch", fulfilment: "Collect", status: "Ready", totalCents: 89900, items: [{ name: "Cobra Basin Mixer - Black", qty: 1, priceCents: 89900 }] },
  { ref: "BI-5T1V9W", date: "2026-06-02", customer: "Naledi Khumalo", store: "Build It Strand", fulfilment: "Delivery", status: "Out for delivery", totalCents: 599900, items: [{ name: "Weber Master-Touch 57cm", qty: 1, priceCents: 599900 }] },
  { ref: "BI-8X3Y2Z", date: "2026-05-30", customer: "Sipho Mthembu", store: "Build It Stellenbosch", fulfilment: "Collect", status: "Completed", totalCents: 109900, items: [{ name: "DeWalt 115mm Angle Grinder", qty: 1, priceCents: 109900 }] },
];
...
export const ADMIN_QUOTES: AdminQuote[] = [
  { ref: "Q-3H9X2P", date: "2026-06-03", customer: "BuildRight Construction", store: "Build It Strand", area: "Local (within 30km)", status: "New", items: [{ name: "PPC Surebuild Cement 50kg", qty: "40" }, { name: "Building Sand", qty: "3 cubes" }] },
  { ref: "Q-1B7T5K", date: "2026-06-02", customer: "M. Botha", store: "Build It Stellenbosch", area: "Regional (30-100km)", status: "New", items: [{ name: "Imperial Clay Stock Bricks", qty: "3000" }] },
  { ref: "Q-6L4N8J", date: "2026-06-01", customer: "Coastal Plumbers", store: "Build It Strand", area: "Local (within 30km)", status: "Quoted", items: [{ name: "Kwikot 150L Geyser", qty: "4" }] },
  { ref: "Q-9D2F7G", date: "2026-05-29", customer: "Ridgeview Homes", store: "Build It Stellenbosch", area: "Local (within 30km)", status: "Accepted", items: [{ name: "PPC Surebuild Cement Pallet", qty: "2" }] },
];
...
export const AUDIENCES = [
  ...
  { id: "strand", label: "Strand store customers", size: 1980 },
  { id: "stellenbosch", label: "Stellenbosch store customers", size: 1140 },
];
